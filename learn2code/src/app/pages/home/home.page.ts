  ...
  public langs: any = [
    {
      id: 1,
      name: 'Python',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/768px-Python-logo-notext.svg.png',
      Desc: 'An interpreted, object-oriented, high-level programming language with dynamic semantics.',
    },
    {
      id: 2,
      name: 'Java',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/en/3/30/Java_programming_language_logo.svg',
    ...
    },
    {
      id: 3,
      name: 'JavaScript',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/6/6a/JavaScript-logo.png',
    ...
    },
    {
      id: 4,
      name: 'C++',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/1/18/ISO_C%2B%2B_Logo.svg',
      Desc: 'A general-purpose programming language created as an extension of the C programming language.',
    },
    {
      id: 5,
      name: 'PHP',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/2/27/PHP-logo.svg',
      Desc: 'A general-purpose scripting language especially suited to web development.',
    },
    {
      id: 6,
      name: 'Swift',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/9/9d/Swift_logo.svg',
      Desc: 'A general-purpose, multi-paradigm, compiled programming language developed by Apple Inc. and the open-source community.',
    },
    {
      id: 7,
      name: 'SQL',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/8/87/Sql_data_base_with_logo.png',
    ...
    },
    {
      id: 8,
      name: 'Ruby',
      Pic_Url: 'https://upload.wikimedia.org/wikipedia/commons/7/73/Ruby_logo.svg',
      Desc: 'An interpreted, high-level, general-purpose programming language.',
    },
    {
      id: 9,
      name: 'PoCIT Resources',
      Pic_Url: 'https://peopleofcolorintech.com/wp-content/uploads/2015/08/small-logo-vertical.png',
      Desc: '',
    },
    {
      id: 10,
      name: 'LGBTQIA+ Resources',
      Pic_Url: 'https://therainbowot.files.wordpress.com/2020/06/rainbow-fist-1.png?w=1024',
      Desc: '',
    },
    {
      id: 11,
      name: '#LetIndiaBreathe Resources',
      Pic_Url: 'https://www.letindiabreathe.in/logowhite-1.png',
      Desc: '',
    },
    {
      id: 12,
      name: 'Mental Health Support',
      Pic_Url: 'https://wfmh.global/wp-content/uploads/2018/01/wfmh-logo.png',
      Desc: '',
    },
  ];
  public teams = [
